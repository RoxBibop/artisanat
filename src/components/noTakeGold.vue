<template>
  <div class="noTakeGold">
    <p class="text">Tu n'as donc pas réussi a récupérer l'or tant espéré. Tu retournes vers le lieu de la rencontre et le druide<br> t'y attends déjà. Tu peux voir de la déception voire même de la colère dans son regard...
